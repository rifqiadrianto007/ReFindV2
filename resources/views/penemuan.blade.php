...
<body class="min-h-screen p-4 bg-white md:p-8" x-data="{ showModal: false, jenisLaporan: 'penemuan' }">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="mb-8 text-center">
            <div class="inline-flex items-center justify-center mb-4">
                ...
                <h1 class="mx-6 text-3xl font-bold text-black md:text-4xl">Data Penemuan</h1>
                <div class="w-32 h-1 rounded-full header-line"></div>
            </div>
            <p class="text-lg text-slate-600">Daftar barang yang ditemukan dan dilaporkan pengguna</p>
        </div>
