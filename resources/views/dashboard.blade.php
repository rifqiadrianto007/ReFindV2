        ...
        <div class="w-full h-[300px] relative overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 w-full p-6 md:p-12 text-white">
                <div class="max-w-7xl mx-auto">
                    ...
                    <p class="text-lg md:text-xl opacity-90 max-w-2xl">Temukan dan laporkan barang hilang dengan mudah.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="fitur" class="py-20 bg-blue-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-20">
                <div class="bg-blue-800 rounded-xl overflow-hidden shadow-lg transform transition hover:-translate-y-1">
                    <div class="p-8">
                        <div
